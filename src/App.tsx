...
import { channels, CATEGORIES, Channel } from './data';
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex items-center justify-between">
                <div className="flex items-center gap-4">
                  <img 
                    ...
                    className="w-12 h-12 rounded-lg bg-slate-950 border border-slate-800 shadow-inner"
                    alt=""
                  />
                  <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3">
              {filteredChannels.map((channel) => (
                <button
                  ...
                  className={cn(
                    "flex flex-col items-center gap-3 p-4 rounded-xl transition-all text-center group border border-transparent shadow-sm",
                ...
                >
                  <div className="relative shrink-0">
                    <img 
                      src={channel.logo} 
                      alt={channel.name}
                      className="w-16 h-16 rounded-xl object-cover bg-slate-950 border border-slate-800 shadow-sm"
                      onError={(e) => {
